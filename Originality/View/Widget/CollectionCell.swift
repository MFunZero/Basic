    ...
    var filename:String? {
        ...
        didSet{
            ...
            if isExits && image != nil{
                print("111111")
//                let size = image!.scaleImage(image!, imageLength: self.pictureView.frame.height)
//                self.imageView.frame = CGRect(x: 0, y: 0, width: self.pictureView.frame.width, height: size.height)
                self.imageView.center = self.pictureView.center
...
//                        self.imageView.frame = CGRect(x: 0, y: 0, width: self.pictureView.frame.width, height: size.height)
    ...
    override func drawRect(rect: CGRect) {
        ...
        pictureView.frame = CGRect(x: 0, y: 0, width: self.frame.width, height: topContentView.frame.height * 4 / 5 )
        ...
        self.topContentView.addSubview(pictureView)
