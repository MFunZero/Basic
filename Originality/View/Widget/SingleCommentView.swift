        ...
        didSet{
            ...
            query.getObjectInBackgroundWithId(commenter) { (bj, error) -> Void in
                if error != nil {
                    ...
                    if let authorAvator = bj.objectForKey("avatar")  {

                    BmobProFile.getFileAcessUrlWithFileName(authorAvator as! String) { (file, error) -> Void in
                        if error != nil {
...
//            let commentId = commentDetail!.objectForKey("commentId") as! String
    ...
    override func drawRect(rect: CGRect) {
        ...
        headerView.frame = CGRect(x: 10, y: 5, width: 40, height: 40)
