...
class PersonTableViewCell: UITableViewCell {
    ...
    override func drawRect(rect: CGRect)
    {
        ...
        titleLabel.frame =  CGRect(x: picture.frame.origin.x + picture.frame.width + 15, y: 10, width: self.frame.width - (picture.frame.width + 35)*2, height: self.frame.height - 20)
