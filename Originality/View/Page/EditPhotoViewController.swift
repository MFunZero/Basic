...
class EditPhotoViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        var imageSize = photoView.image!.scaleImage(photoView.image!, imageLength: screenHeight - 94)
        
        
        photoView.frame = CGRect(x: 20, y: 74, width: screenWidth - 40, height: imageSize.height)
