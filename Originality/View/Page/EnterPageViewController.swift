...
class EnterPageViewController: UIViewController {
    ...
    func configForView()
    {
        ...
        cancelButton.addTarget(self, action: #selector(EnterPageViewController.userClick(_:)), forControlEvents: .TouchUpInside)
        ...
        loginButton.addTarget(self, action: #selector(EnterPageViewController.loginButtonClick(_:)), forControlEvents: .TouchUpInside)
        ...
        regesiterButton.addTarget(self, action: #selector(EnterPageViewController.regesiterButtonClick(_:)), forControlEvents: .TouchUpInside)
